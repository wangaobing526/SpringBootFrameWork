...
//
//	public final static String CAHCHE_TYPE_DICTIONARY = "dataDictionary";// 数据字典缓存名称
//	public final static String CAHCHE_DICTIONARY_KEYNAME = "dataDictionary-TreeList";// 字典名称
//																						// 关联字典项
//	public final static String CAHCHE_DICTIONARY_KEYALL = "dataDictionary-allDictionary";// 字典名称
//																							// 关联字典项
//
//	@Autowired
